# Live Text-to-Speech Makefile (PHP / Ratchet)
...
help:
	@echo "Live Text-to-Speech (PHP) - Available Commands"
	@echo "================================================"
	@echo ""
	@echo "Setup:"
	...
	@echo "  make install-backend   Install backend (composer) dependencies only"
	...
	@echo "  make clean             Remove vendor, node_modules, and build artifacts"
...
clean:
	@echo "==> Cleaning vendor, node_modules, and build artifacts..."
	rm -rf vendor

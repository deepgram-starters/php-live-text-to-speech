# php-live-text-to-speech

PHP demo app for Deepgram Live Text-to-Speech.
...
```
feat(php-live-text-to-speech): add diarization support
fix(php-live-text-to-speech): resolve WebSocket close handling
refactor(php-live-text-to-speech): simplify session endpoint
